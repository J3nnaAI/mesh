module github.com/J3nnaAI/mesh/examples/order-fulfillment/vault-service
...
require (
	...
	github.com/J3nnaAI/mesh/vault v0.2.0
)
...
replace github.com/J3nnaAI/mesh/vault => ../../../vault
